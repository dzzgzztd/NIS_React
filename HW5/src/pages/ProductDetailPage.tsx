...
const ProductDetailPage: React.FC = () => {
    ...
    return (
        <Container sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '75vh', marginTop: 4 }}>
                        ...
                        <Box sx={{
                            ...
                            {product.image ? (
                                <img
                                    src={product.image}
                                    alt={product.name}
                                    style={{ width: '100%', maxHeight: '500px', objectFit: 'contain', borderRadius: 10 }}
                                />
                            ) : (
